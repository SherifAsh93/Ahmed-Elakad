...
export default async function ContactPage() {
  ...
  return (
    <main className="bg-[#f0f0f0] min-h-screen pt-16 md:pt-24 pb-10 md:pb-20 px-0 md:px-8">
      <div className="max-w-[1200px] mx-auto md:shadow-2xl overflow-hidden flex flex-col md:flex-row">

        {/* Column 1: Editorial Image & Title (Left) */}
        <div className="w-full md:w-[30%] relative h-[260px] md:h-auto md:min-h-0 md:border-r md:border-stone-100 bg-white">
          <img
            src={heroImage}
            alt="Contact Us"
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-6">
            <div className="bg-white/85 backdrop-blur-md px-8 py-6 md:px-10 md:py-10 border border-stone-100 shadow-xl text-center">
              <h1 className="font-serif text-2xl md:text-4xl uppercase tracking-[0.2em] text-stone-800 mb-2 md:mb-3 whitespace-nowrap">
                Contact Us
              </h1>
        ...
        {/* Column 2: Appointment Info (Middle) */}
        <div className="w-full md:w-[35%] bg-white flex flex-col md:border-r md:border-stone-200">
          {/* Header section */}
          <div className="px-5 md:px-10 pt-7 md:pt-10 pb-5 md:pb-6">
            <h2 className="font-serif text-xl md:text-2xl font-bold text-stone-900 mb-2 md:mb-4 leading-tight">
              Make An Appointment
            </h2>
          ...
          {/* Contact details */}
          <div className="px-5 md:px-10 divide-y divide-stone-200">
            {/* Call Us */}
            <div className="py-3.5 md:py-6">
              <h3 className="text-[10px] uppercase tracking-[0.4em] font-bold text-stone-400 mb-1">Call Us</h3>
              {phones.length > 0 ? (
                phones.map((p, i) => (
                  <a key={i} href={"tel:" + p} className="block text-stone-700 hover:text-[#b3a384] transition-colors text-sm font-light tracking-wide uppercase">
                    {p}
                  </a>
                ))
              ) : (
            ...
            <div className="py-3.5 md:py-6">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex w-9 h-9 md:w-10 md:h-10 rounded-full border border-stone-200 items-center justify-center text-stone-500 hover:border-[#b3a384] hover:text-[#b3a384] transition-all duration-300"
              >
        ...
        {/* Column 3: Form (Right) — on mobile: clearly separated with grey background */}
        <div className="w-full md:w-[35%] bg-[#eeeeee] px-5 pt-8 pb-10 md:px-12 md:py-12 flex flex-col justify-center border-t-4 border-stone-300 md:border-t-0">
          <ContactForm />
        </div>
