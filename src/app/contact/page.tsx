...
export default async function ContactPage() {
  ...
  return (
    <main className="bg-[#e8e8e8] pt-16 md:pt-20">
      ...
      <div className="md:hidden flex flex-col">
        ...
        {/* Form card */}
        <div className="mx-4 mt-3 mb-8 bg-[#eeeeee] shadow-sm px-5 py-7">
          <ContactForm />
        </div>
      ...
      <div className="hidden md:flex max-w-[1200px] mx-auto md:px-8 shadow-2xl overflow-hidden flex-row">
        ...
        {/* Column 1: Image */}
        <div className="w-[30%] relative border-r border-stone-100 bg-white self-stretch min-h-[600px]">
          <img src={heroImage} alt="Contact Us" className="absolute inset-0 w-full h-full object-cover" />
        ...
        {/* Column 3: Form */}
        <div className="w-[35%] bg-[#eeeeee] px-12 py-16 flex flex-col">
          <h2 className="font-serif text-xl font-bold text-stone-900 mb-2 leading-tight">
            Send Us a Message
          </h2>
          <p className="text-stone-400 font-light text-xs tracking-[0.2em] uppercase mb-8">
