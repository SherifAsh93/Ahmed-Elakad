  ...
  return (
    <header className="w-full absolute top-0 left-0 z-50">
      ...
      <div className="relative z-[60] bg-white border-b border-gray-50 shadow-sm">
        <div className="flex justify-between items-center h-[75px] sm:h-[64px] px-4 sm:px-8 max-w-[1440px] mx-auto">
          {/* Logo */}
          ...
          <button
            ...
            className="block md:hidden p-2 text-[#1a1a1a] hover:text-[#b3a384] transition-colors focus:outline-none"
          ...
          {NAV_LINKS.map((link) => {
            ...
            return (
              <Link
                ...
                className={`block w-full px-6 py-[14px] text-[13px] tracking-[2.5px] uppercase transition-colors ${isActive
