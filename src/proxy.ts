...
export const config = {
  matcher: [
    "/((?!api|admin|_next/static|_next/image|favicon.ico|apple-icon.png|icon.png|opengraph-image.png|twitter-image.png|robots.txt|sitemap.xml|media|file.svg|globe.svg|next.svg|vercel.svg|window.svg).*)",
  ],
};
